...
public class LoginTicketGeneratorFilterTest
{
	...
	{
		if (usernameProvider instanceof InMemoryUsernameProvider)
		{
			InMemoryUsernameProvider inMem = (InMemoryUsernameProvider) usernameProvider;
			inMem.addMapping("test", "testUser", "test");
		}
	}
